...
export function WorkshopCard({ workshop }: WorkshopCardProps) {
    ...
    return (
        <div className="rounded-2xl border border-slate-800 bg-slate-900/50 p-5 flex flex-col justify-between gap-4 shadow-sm hover:border-sky-500/60 hover:shadow-[0_0_30px_rgba(56,189,248,0.15)] transition">
